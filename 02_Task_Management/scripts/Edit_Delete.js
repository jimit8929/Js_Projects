...
//     const now = new Date();
//     dateDiv.textContent = `Created: ${now.toLocaleString()}`;
// });
...
// let currentTask;  // reference to the .task being acted on

// // Helper to show/hide
// function show(modal) { modal.classList.add('show'); }
// function hide(modal) { modal.classList.remove('show'); }

// // 1) Open OPTIONS modal on “⋮” click
...
//     prioritySpan.className = 'indicator inline-block p-3 rounded-md font-bold ' +
//         (prioritySel.value === 'High' ? 'bg-violet-500' :
//          prioritySel.value === 'Medium' ? 'bg-orange-400' :
//          prioritySel.value === 'Low' ? 'bg-cyan-300' : 'bg-cyan-300');
//     prioritySpan.textContent = prioritySel.value;
//     ms.append(prioritySpan);

//     // Status indicator
//     const statusSpan = document.createElement('p');
//     statusSpan.className = 'indicator inline-block p-3 rounded-md font-bold ' +
//         (statusSel.value === 'On Track' ? 'bg-green-400' :
//          statusSel.value === 'At Risk' ? 'bg-yellow-300' :
//          statusSel.value === 'Off Track' ? 'bg-pink-300' : 'bg-pink-300');
//         statusSpan.textContent = statusSel.value;
//         ms.append(statusSpan);

//     hide(editModal);
// });

// // 3) If “Delete Task” clicked → show confirmation
...
//     if (currentTask) {
//         currentTask.remove();
//         updateQuantities(); // Assuming this function exists elsewhere
//     }
//     hide(confirmModal);
// });
